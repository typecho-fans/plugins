...
名称 | 简介 | 作者
---- | :----: | ----:
[Access](https://github.com/kokororin/typecho-plugin-Access) | 来访记录统计插件 | [@Kotori](https://github.com/kokororin)
[Adminer](https://github.com/kokororin/typecho-plugin-adminer) | 数据库管理插件 | [@Kotori](https://github.com/kokororin)
[AjaxComments](/AjaxComments) | 嵌套评论Ajax提交插件 | [@Byends](https://github.com/visamz) Willin Kan
[AllowIp](/AllowIp) | 后台IP白名单插件 | [@Fuzqing](https://github.com/fuzqing)
[AMP](/AMP) | AMP/MIP标准页面生成插件 | [@Holmesian](https://github.com/holmesian)
...
[AutoTags](/AutoTags) | 文章标签自动生成插件 | [@DT27](https://github.com/DT27)
[Avatars](/Avatars) | 读者墙头像排行插件(支持缓存) | [@羽中](https://github.com/jzwalk)
[BackToTop](/BackToTop) | 二次元返回顶部插件 | [@夏目贵志](https://github.com/xiamuguizhi)
[BaeUpload](/BaeUpload) | 百度应用引擎BAE上传插件 | [@兜兜](https://github.com/doudoutime)
[BlockIP](https://github.com/kokororin/typecho-plugin-BlockIP) | 前台IP黑名单插件 | [@Kotori](https://github.com/kokororin)
...
[Ckeditor4Typecho](/Ckeditor4Typecho) | CKEditor可视化编辑器插件 | [@zhulin3141](https://github.com/zhulin3141)
[CodeMirror](/CodeMirror) | 外观编辑器语法高亮插件 | [@zhulin3141](https://github.com/zhulin3141)
...
[CommentToMail](/CommentToMail) | 评论邮件提醒插件 | [@Byends](https://github.com/visamz) [@阿飞](https://github.com/defeme)
[ContentIndex](/ContentIndex) | 嵌入式文章目录树插件 | [@laobubu](https://github.com/laobubu)
[Contribute](/Contribute) :dart: | 用户投稿+审查管理插件 | [@ShingChi](https://github.com/shingchi)
[CosForTypecho](https://github.com/CharmeRyl/typecho-plugin-cosfile) | 腾讯云储存COS插件 | [@CharmeRyl](https://github.com/CharmeRyl)
[DbManager](/DbManager) | 数据库备份与优化插件 | [@ShingChi](https://github.com/shingchi)
[DevTool](/DevTool) | Typecho开发者测试插件 | [@zhulin3141](https://github.com/zhulin3141)
[DownloadFile](/DownloadFile) | 附件保持原名下载插件 | [@DT27](https://github.com/DT27)
[Duoshuo](/Duoshuo) :warning: | 多说社会化评论同步插件 | [@阳光](https://github.com/rakiy)
...
[GeeTest](/GeeTest) | GeeTest评论验证码插件 | [@啸傲居士](https://github.com/shuxiao9058)
[GHbutton](/GHbutton) | Github项目按钮展示插件 | [@羽中](https://github.com/jzwalk)
[GithubCard](/GithubCard) | Github项目卡片展示插件 | [@车坤](https://github.com/chekun)
[GithubWidgetUser](/GithubWidgetUser) | Github作者名片展示插件 | [@hongweipeng](https://github.com/hongweipeng)
[GoLinks](/GoLinks) | 外链改内链跳转插件 | [@阿飞](https://github.com/defeme)
[GoodLuck](/GoodLuck) | 随机文章链接插件 | [@逗妇乳](https://github.com/benzBrake)
[GoogleCodePrettfy](/GoogleCodePrettify) | Google代码高亮插件 | [@公子](https://github.com/lizheming)
[GravatarCache](/GravatarCache) :dart: | Gravatar头像缓存插件 | [@Byends](https://github.com/visamz)
[Hermit](/Hermit) | 虾米音乐列表型播放器插件 | [@牧风](https://github.com/iMuFeng)
[HighSlide](/HighSlide) | 图片灯箱弹窗+页面相册插件 | [@羽中](https://github.com/jzwalk)
[Html2Text](/Html2Text) | Html代码转Markdown格式插件 | [@冰剑](https://github.com/binjoo)
[HTMLCompress](https://github.com/kokororin/typecho-plugin-HTMLCompress) | Html代码压缩插件 | [@Kotori](https://github.com/kokororin)
[IQapTcha](/IQapTcha) | 评论滑动解锁验证插件 | [@Byends](https://github.com/visamz)
...
[MostCache](/MostCache) | 数据库Memcache缓存插件 | [@skylzl](https://github.com/xiaogouxo)
[MyPlayer](/MyPlayer) | 影音站链接转播放器插件 | [@perichr](http://github.com/perichr)
[MyTagCloud](/MyTagCloud) | Typecho标签云设置插件 | [@马燕龙](https://github.com/YanlongMa)
[OssForTypecho](https://github.com/CharmeRyl/typecho-plugin-ossfile) | 阿里云储存OSS插件 | [@CharmeRyl](https://github.com/CharmeRyl)
[Parsedown](https://github.com/kokororin/typecho-plugin-Parsedown) | Markdown解析器替换插件 | [@Kotori](https://github.com/kokororin)
[Passport](/Passport) :dart: | 用户密码找回功能插件 | [@ShingChi](https://github.com/shingchi)
...
[SCS](/SCS) | 新浪云存储SCS插件 | [@vfhky](https://github.com/vfhky)
[ShortLinks](/ShortLinks) | 自定义短链接跳转插件 | [@逗妇乳](https://github.com/benzBrake)
...
[SyncPost](/SyncPost) :warning: | 多平台更新推送插件 | [@冰剑](https://github.com/binjoo)
[TeKit](/TeKit) | 常用侧边栏数据输出插件 | [@冰剑](https://github.com/binjoo)
...
[Typembed](/Typembed) | 视频站链接转播放器插件 | [@fengzi](https://github.com/nothingisover)
[Ueditor](/Ueditor) | 百度编辑器Ueditor插件 | [@zhulin3141](https://github.com/zhulin3141)
[Ugauka](/Ukagaka) | (娱乐向)二次元伪春菜插件 | [@Kunr](https://github.com/Rakume)
[Update](/Update) | 一键升级开发版插件 | [@公子](https://github.com/lizheming)
[UpdateAssistant](https://github.com/mrgeneralgoo/typecho-update-assistant)  | 自动升级插件(可选版本) | [@程小白](https://github.com/mrgeneralgoo) 
[UploadPlugin](/UploadPlugin) | 自动安装+删除扩展插件 | [@阿飞](https://github.com/defeme)
[UserSign](/UserSign) :dart: | 用户个性签名插件 | [@H萌](https://github.com/hmoe)
[Watermark](/Watermark) | 图片自动加水印插件 | [@阿飞](https://github.com/defeme)
[WeChatShare](/WeChatShare) | 微信分享链接定制插件 | [@Fuzqing](https://github.com/fuzqing)
