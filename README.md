...
1. 本目录下作品应为经作者同意允许在这里进行**多人自由更新**的，如果只是想在插件仓库列表登记编辑[TESTORE.md](TESTORE.md)即可。
 ...
 > 本目录下插件在仓库列表中带有社区版标记，作者可提交有特色但不再维护的作品，由其他成员视需求能力做后续修正。
...
###### TeStore插件仓库将使用下表“名称”创建安装文件夹，“版本”提示升级，请务必确保文本准确；注意同目录排序，自增上方插件数，简介不要过长。
```
对于已安装同名插件TeStore会核对Plugin.php中的版本号与作者名，所以请参与维护童鞋也记得在插件文件中用空格分隔署名，以避免社区版与原版区别不开的情况。
```

名称 | 简介 | 版本 | 作者 | zip包
---- | :----: | :---: | ----: | :----:
[AMP](AMP) | 移动端AMP/MIP页面生成插件 | 0.6.4 | [Holmesian](https://github.com/holmesian) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/AMP.zip)
...
[AppStore](AppStore) | Go脚本服务端搭配版应用商店插件 | 2.0.0 | [车坤](https://github.com/chekun) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/AppStore.zip)
[ArticleList](ArticleList) | 热评/随机(支持缓存)文章列表插件 | 1.1.1 | [阿飞](https://github.com/defeme) | [Special](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/ArticleList.zip)
[ArticleTemplate](ArticleTemplate) | Typecho文章类型字段设置插件 | 1.0.0 | [逗妇乳](https://github.com/benzBrake) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/ArticleTemplate.zip)
...
[CateFilter](CateFilter) | 首页过滤指定分类文章不显示插件 | 1.2.1 | [阳光](https://github.com/rakiy) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/CateFilter.zip)
...
[CommentToMail](CommentToMail) | 发布或回复评论邮件自动提醒插件 | 2.0.1 | [Byends](https://github.com/visamz) [阿飞](https://github.com/defeme) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/CommentToMail.zip)
...
[GithubCard](GithubCard) | Github项目/用户信息卡片展示插件 | 1.0.0 | [车坤](https://github.com/chekun) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-D_to_G/GithubCard.zip)
...
[GoLinks](GoLinks) | 指定内链自动跳转至关联外链插件  | 0.3.0 | [阿飞](https://github.com/defeme) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-D_to_G/GoLinks.zip)
[GoodLuck](GoodLuck) | “手气不错”链接显示随机文章插件 | 1.0.1 | [逗妇乳](https://github.com/benzBrake) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-D_to_G/GoodLuck.zip)
...
[MyTagCloud](MyTagCloud) | Typecho自定义标签云输出插件 | 1.0.0 | [马燕龙](https://github.com/YanlongMa) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-M_to_R/MyTagCloud.zip)
...
[QNUpload](QNUpload) | 经典版(php5.2-5.6)七牛附件插件 | 1.3.1 | [阳光](https://github.com/rakiy) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-M_to_R/QNUpload.zip)
...
[Reposidget](Reposidget) | Github项目信息与内容展示插件 | 1.0.0 | [西秦](https://github.com/xiqingongzi) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-M_to_R/Reposidget.zip)
...
[RoutesHelper](RoutesHelper) | Typecho路由信息显示与修改插件 | 1.0.3 | [兜兜](https://github.com/doudoutime) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-M_to_R/RoutesHelper.zip)
...
[ShortLinks](ShortLinks) | 自动替换或指定内链跳转外链插件 | 1.0.7 | [逗妇乳](https://github.com/benzBrake) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/ShortLinks.zip)
[Sinauth](Sinauth) | 新浪用户授权注册帐号与登录插件 | 1.0.0 | [Web3D](https://github.com/web3d) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/Sinauth.zip)
...
[Sticky](Sticky) | Typecho文章首页/分类页置顶插件 | 1.0.1 | [逗妇乳](https://github.com/benzBrake) Willin Kan | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/Sticky.zip)
[Subscriber](Subscriber) | 指定文章/内容对登录会员可见插件 | 1.0.0 | [羽中](https://github.com/jzwalk) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/Subscriber.zip)
...
[TeStore](TeStore) | 新Github表格解析版插件仓库插件 | 1.0.0 | [zhulin3141](https://github.com/zhulin3141) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/TeStore.zip)
[ThemeDemo](ThemeDemo) | 根据链接参数直接预览主题外观插件 | 1.0.1 | [兜兜](https://github.com/doudoutime) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/ThemeDemo.zip)
...
[UploadPlugin](UploadPlugin) | 上传zip包安装删除插件/主题插件 | 1.1.3 | [阿飞](https://github.com/defeme) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/UploadPlugin.zip)
[UserSign](UserSign) | 用户个性签名文字设置与输出插件 | 0.0.1 | [H萌](https://github.com/hmoe) | [Special](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/UserSign.zip)
[Watermark](Watermark) | 文章内图片自动添加水印效果插件 | 1.2.0 | [阿飞](https://github.com/defeme) | [Download](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/Watermark.zip)
