...
* @version 0.9.9
* @create 2014.2.7
* @lastmodified 2014-02-10 06:02
* @description Hermit Plugin
* @author MuFeng (http://mufeng.me)
* @url http://mufeng.me/hermit-for-wordpress.html
**/
!function(a,b,c){var d="goXiami",e=soundManager,f=null,g=null,h=[],i={},j=function(){var a=-1;if("Microsoft Internet Explorer"==navigator.appName){var b=navigator.userAgent,c=new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");null!=c.exec(b)&&(a=parseFloat(RegExp.$1))}else if("Netscape"==navigator.appName){var b=navigator.userAgent,c=new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})");null!=c.exec(b)&&(a=parseFloat(RegExp.$1))}return a}(),k="createTouch"in b||"ontouchstart"in a,l=k?"touchstart":"click",m=k?"touchstart":"mousedown",n=k?"touchmove":"mousemove",o=k?"touchend":"mouseup";e.url=hermit.url,e.debugMode=!1,e.preferFlash=j>5?!0:!1,i.init=function(){this.fn.getjson()},i.fn={handleHash:{},bind:function(){return b.addEventListener?function(a,b,c){b.addEventListener(a,function(){c.apply(this,arguments),i.fn.handleHash[a]=i.fn.handleHash[a]||[],i.fn.handleHash[a].push(arguments.callee)},!1)}:b.attachEvent?function(a,b,c){b.attachEvent("on"+a,function(){c.apply(this,arguments),i.fn.handleHash[a]=i.fn.handleHash[a]||[],i.fn.handleHash[a].push(arguments.callee)})}:void 0}(),unbind:function(){return b.removeEventListener?function(a,b){if(i.fn.handleHash[a]){var c=0,d=i.fn.handleHash[a].length;for(c;d>c;c+=1)b.removeEventListener(a,i.fn.handleHash[a][c],!1)}}:b.detachEvent?function(a,b){if(i.fn.handleHash[a]){var c=0,d=i.fn.handleHash[a].length;for(c;d>c;c+=1)b.detachEvent("on"+a,i.fn.handleHash[a][c])}}:void 0}(),rclass:/[\n\t]/g,rspaces:/\s+/,arraify:function(a){var b=[];try{b=Array.prototype.slice.call(a,0)}catch(c){for(var d,b=[],e=0;d=a[e++];)b.push(d)}return b},hasClass:function(a,b){return 0<=(" "+a.className+" ").replace(i.fn.rclass," ").indexOf(" "+b+" ")?!0:!1},addClass:function(a,b){if(b&&"string"==typeof b){var c=(b||"").split(i.fn.rspaces);if(1===a.nodeType)if(a.className){for(var d=" "+a.className+" ",e=a.className,f=0,g=c.length;g>f;f++)0>d.indexOf(" "+c[f]+" ")&&(e+=" "+c[f]);a.className=i.fn.trim(e)}else a.className=b}},removeClass:function(a,b){if(b&&"string"==typeof b||void 0===b){var c=(b||"").split(i.fn.rspaces);if(1===a.nodeType&&a.className)if(b){for(var d=(" "+a.className+" ").replace(i.fn.rclass," "),e=0,f=c.length;f>e;e++)d=d.replace(" "+c[e]+" "," ");a.className=i.fn.trim(d)}else a.className=""}},getById:function(a){return b.getElementById(a)},getByTagName:function(a,c){return c=c||b,i.fn.arraify(c.getElementsByTagName(a))},getByClassName:function(a,c,d){if(c=c||b,c.getElementsByClassName)return i.fn.arraify(c.getElementsByClassName(a));for(var a=a.replace(/\-/g,"\\-"),e=[],c=i.fn.getByTagName(d||"*",c),d=c.length,a=RegExp("(^|\\s)"+a+"(\\s|$)");d--;)a.test(c[d].className)&&e.push(c[d]);return e.reverse(),e},each:function(a,b){if(c!=a.length)for(var d=0,e=a.length;e>d&&!1!==b.call(a[d],d,a[d]);d++);else for(name in a)b.call(a[name],name,a[name])},index:function(a,b){var c,d=b.length;for(c=0;d>c;c++)if(a==b[c])return c;return-1},trim:function(a){return a.replace(/^(\s|\u00A0)+/,"").replace(/(\s|\u00A0)+$/,"")},getjson:function(){i.fn.each(i.fn.getByClassName("hermit"),function(a){var b=this,c=b.getAttribute("songs").split("#:"),d=c[0],e=c[1];i.fn.ajaxp({url:"http://goxiami.sinaapp.com/beta.php/",param:{type:d,id:e},after:function(c){i.fn.createPlayListUI.call(b,c,a)}})})},create:function(a){var b=this;g=null!=a?a:0,f=null!=f?f:0,i.sound&&(i.sound.destruct(),f==h[g].length&&(f=0)),e.onready(function(){i.sound=e.createSound({id:d,url:h[g][f].src,volume:80,autoLoad:!1,onload:function(){this.readyState<3&&alert("音乐播放器初始化失败!")},whileloading:function(){var a=i.fn.getByClassName("hermit-loaded",b,"div")[0],c=this.bytesLoaded/this.bytesTotal*100+"%";a.style.width=c},whileplaying:function(){var a=i.fn.getByClassName("hermit-duration",b,"div")[0],c=i.fn.getByClassName("hermit-prosess-bar",b,"div")[0],d=this.position/this.duration*100+"%",e=i.fn.parseTime(this.position/1e3)+"/"+i.fn.parseTime(this.duration/1e3);!i.moving&&(c.style.width=d),a.innerHTML=e},onplay:function(){var a=i.fn.getByClassName("hermit-song",b,"div"),c=i.fn.getByClassName("hermit-detail",b,"div")[0];i.fn.each(a,function(){i.fn.removeClass(this,"selected")}),i.fn.addClass(a[f],"selected"),c.innerHTML=i.fn._expect(a[f].innerHTML,0,40,"...")+"  ("+(f+1)+"/"+h[g].length+")"},onpause:function(){},onfinish:function(){if(f++,i.sound.resume(),f<h[g].length)i.fn.create.call(b,g);else{var a=i.fn.getByClassName("hermit-prosess-bar",b,"div")[0],c=i.fn.getByClassName("hermit-button",b,"div")[0],d=i.fn.getByClassName("hermit-duration",b,"div")[0],e=i.fn.getByClassName("hermit-song",b,"div");i.fn.each(e,function(){i.fn.removeClass(this,"selected")}),a.style.width=0,f=null,g=null,i.sound=null,d.innerHTML="",i.fn.removeClass(c,"playing")}}}),i.sound.play()})},createPlayListUI:function(a,b){var c=this,d=i.fn.getByClassName("hermit-list",c,"div")[0],e="";if(h[b]=[],a.album_id)a=a.songs,i.fn.each(a,function(){h[b].push({src:this.song_src}),e+='<div class="hermit-song">'+this.song_title+" - "+this.song_author+"</div>"});else{var f=c.getAttribute("songs").split("#:"),g=f[1];g=g.split(","),i.fn.each(g,function(){h[b].push({src:a[this].song_src}),e+='<div class="hermit-song">'+a[this].song_title+" - "+a[this].song_author+"</div>"})}d.innerHTML=e,i.fn.playEvent.call(c)},playEvent:function(){var a=this,b=i.fn.getByClassName("hermit-button",a,"div")[0],c=i.fn.getByClassName("hermit-listbutton",a,"div")[0],d=i.fn.getByClassName("hermit-list",a,"div")[0],e=i.fn.getByClassName("hermit-song",d,"div"),h=parseInt(i.fn._getStyle(e[0],"height"))+1,j=h*e.length+"px",k=i.fn.getByClassName("hermit-prosess",a,"div")[0],n=i.fn.getByClassName("hermit-prosess-after",k,"div")[0];d.style.height=j,i.fn.each(e,function(){var c=this,d=i.fn.index(a,i.fn.getByClassName("hermit"));c.onclick=function(){var c=i.fn.index(this,e);if(g==d)c==f?b.click():(f=c,i.fn.create.call(a,d));else{if(i.sound){var h=i.fn.getByClassName("hermit")[g],j=i.fn.getByClassName("hermit-button",h,"div")[0],k=i.fn.getByClassName("hermit-song",h,"div")[f];i.fn.removeClass(j,"playing"),i.fn.removeClass(k,"selected"),i.sound.resume()}f=c,i.fn.addClass(b,"playing"),i.fn.create.call(a,d)}}}),i.fn.bind(l,b,function(){var c=i.fn.index(a,i.fn.getByClassName("hermit"));if(i.fn.hasClass(b,"playing"))i.fn.removeClass(b,"playing"),i.sound.pause();else if(i.fn.addClass(b,"playing"),i.sound&&g==c)i.sound.play();else{if(i.sound){var d=i.fn.getByClassName("hermit")[g],e=i.fn.getByClassName("hermit-button",d,"div")[0],h=i.fn.getByClassName("hermit-song",d,"div")[f];f=null,i.fn.removeClass(e,"playing"),i.fn.removeClass(h,"selected")}i.fn.create.call(a,c)}}),i.fn.bind(l,c,function(){i.fn.hasClass(a,"unexpand")?(i.fn.removeClass(a,"unexpand"),d.style.height=j):(i.fn.addClass(a,"unexpand"),d.style.height=0)}),i.fn.bind(l,k,function(a){if(i.sound){var b=parseInt(i.fn._getStyle(k,"width")),c=i.fn._offset(k).left,d=i.fn._pageEvent(a).pageX-c;d/=b,d*=i.sound.duration,i.sound.setPosition(d)}}),i.fn.bind(m,n,i.fn._bind(i.fn._start,a))},_pageEvent:function(c){if(c=c||a.event,k&&c.touches.length)c.pageX=c.touches.item(0).pageX,c.pageY=c.touches.item(0).pageY;else if("undefined"==typeof c.pageX){var d=b.documentElement,e=b.body;c.pageX=c.clientX+(d&&d.scrollLeft||e&&e.scrollLeft||0)-(d&&d.clientLeft||e&&e.clientLeft||0),c.pageY=c.clientY+(d&&d.scrollTop||e&&e.scrollTop||0)-(d&&d.clientTop||e&&e.clientTop||0)}return c},_expect:function(a,b,c,d){return d=a.length>c-b?d:"",a=a.slice(b,c),a+d},_offset:function(a){var b=a.getBoundingClientRect(),c=a.ownerDocument,d=c.body,e=c.documentElement,f=e.clientTop||d.clientTop||0,g=e.clientLeft||d.clientLeft||0,h=b.top+(self.pageYOffset||e.scrollTop||d.scrollTop)-f,i=b.left+(self.pageXOffset||e.scrollLeft||d.scrollLeft)-g;return{top:h,left:i}},_getStyle:function(a,c){return j>5&&9>j?(c=c.replace(/^(\w)/g,function(a,b){return b.toUpperCase()}),a["client"+c]):b.defaultView.getComputedStyle(a,null).getPropertyValue(c)},_bind:function(a,b){return function(){return a.apply(b,arguments)}},_start:function(){var a=this;i.moving=!0,i.fn.bind(n,b,i.fn._bind(i.fn._move,a)),i.fn.bind(o,b,i.fn._bind(i.fn._end,a)),i.fn.bind("touchcancel",b,i.fn._bind(i.fn._end,a))},_move:function(a){event=i.fn._pageEvent(a);var b=this,c=i.fn.getByClassName("hermit-prosess",b,"div")[0],d=i.fn.getByClassName("hermit-prosess-bar",c,"div")[0],e=parseInt(i.fn._getStyle(c,"width")),f=i.fn._offset(c).left,g=event.pageX-f,h=g/e;h=h>1?1:h,g=100*h+"%",d.style.width=g},_end:function(){{var a=this;i.fn.getByClassName("hermit-prosess-after",a,"div")[0]}if(i.sound){var d=i.fn.getByClassName("hermit-prosess",a,"div")[0],e=i.fn.getByClassName("hermit-prosess-bar",d,"div")[0],f=parseInt(i.fn._getStyle(d,"width")),g=parseInt(i.fn._getStyle(e,"width")),h=g/f;h=h>1?1:h,g=h*i.sound.duration,i.sound.setPosition(g)}i.fn.unbind(n,b),i.fn.unbind(o,b),i.fn.unbind("touchcancel",b);try{delete i.moving}catch(j){i.moving=c}i.fn.handleHash={}},ajaxp:function(c){var d=(new Date).valueOf(),e=b.createElement("script");body=b.documentElement,head=body.getElementsByTagName("head")[0],callbackName="hermit"+parseInt(999999*Math.random()),c.param.callback=callbackName,c.param._=d,a[callbackName]=function(a){c.after.call(this,a),head.removeChild(e)},e.src=c.url+"?"+i.fn.serialize(c.param),head.appendChild(e)},_loadScript:function(a,c){setTimeout(function(){var d=b.createElement("script");d.src=a,d.readyState?i.fn.bind("readystatechange",d,function(){("loaded"===d.readyState||"complete"===d.readyState)&&(c&&c(),i.fn.unbind("readystatechange",d))}):i.fn.bind("load",d,function(){c&&c(),i.fn.unbind("load",d)}),b.getElementsByTagName("head")[0].appendChild(d)},0)},serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}},i.init(),a.player=i}(window,document);