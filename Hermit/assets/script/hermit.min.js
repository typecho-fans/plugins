...
* @version 1.0.4
* @create 2014.2.7
* @lastmodified 2014-04-11 11:00
* @description Hermit Plugin
* @author MuFeng (http://mufeng.me)
* @url http://mufeng.me/hermit-for-wordpress.html
**/
;(function(p,f,t){var l=soundManager,i=null,j=null,k=[],a={},n,q=-1;if("Microsoft Internet Explorer"==navigator.appName){var r=navigator.userAgent,s=/MSIE ([0-9]{1,}[.0-9]{0,})/;null!=s.exec(r)&&(q=parseFloat(RegExp.$1))}else"Netscape"==navigator.appName&&(r=navigator.userAgent,s=/Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/,null!=s.exec(r)&&(q=parseFloat(RegExp.$1)));n=q;var m="createTouch"in f||"ontouchstart"in p,o=m?"touchstart":"click",w=m?"touchstart":"mousedown",u=m?"touchmove":"mousemove",v=m?"touchend":"mouseup";l.url=hermit.url;l.debugMode=!1;l.preferFlash=5<n?!0:!1;a.init=function(){this.fn.getjson()};a.fn={handleHash:{},bind:f.addEventListener?function(c,b,d){b.addEventListener(c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)},!1)}:f.attachEvent?function(c,b,d){b.attachEvent("on"+c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)})}:void 0,unbind:f.removeEventListener?function(c,b){if(a.fn.handleHash[c]){var d=0,e=a.fn.handleHash[c].length;for(d;e>d;d+=1)b.removeEventListener(c,a.fn.handleHash[c][d],!1)}}:f.detachEvent?function(c,b){if(a.fn.handleHash[c]){var d=0,e=a.fn.handleHash[c].length;for(d;e>d;d+=1)b.detachEvent("on"+c,a.fn.handleHash[c][d])}}:void 0,rclass:/[\n\t]/g,rspaces:/\s+/,arraify:function(c){var a=[];try{a=Array.prototype.slice.call(c,0)}catch(d){for(var e,a=[],g=0;e=c[g++];)a.push(e)}return a},hasClass:function(c,b){return 0<=(" "+c.className+" ").replace(a.fn.rclass," ").indexOf(" "+b+" ")?!0:!1},addClass:function(c,b){if(b&&"string"==typeof b){var d=(b||"").split(a.fn.rspaces);if(1===c.nodeType)if(c.className){for(var e=" "+c.className+" ",g=c.className,h=0,f=d.length;f>h;h++)0>e.indexOf(" "+d[h]+" ")&&(g+=" "+d[h]);c.className=a.fn.trim(g)}else c.className=b}},removeClass:function(c,b){if(b&&"string"==typeof b||void 0===b){var d=(b||"").split(a.fn.rspaces);if(1===c.nodeType&&c.className)if(b){for(var e=(" "+c.className+" ").replace(a.fn.rclass," "),g=0,h=d.length;h>g;g++)e=e.replace(" "+d[g]+" "," ");c.className=a.fn.trim(e)}else c.className=""}},getById:function(a){return f.getElementById(a)},getByTagName:function(c,b){return b=b||f,a.fn.arraify(b.getElementsByTagName(c))},getByClassName:function(c,b,d){if(b=b||f,b.getElementsByClassName)return a.fn.arraify(b.getElementsByClassName(c));for(var c=c.replace(/\-/g,"\\-"),e=[],b=a.fn.getByTagName(d||"*",b),d=b.length,c=RegExp("(^|\\s)"+c+"(\\s|$)");d--;)c.test(b[d].className)&&e.push(b[d]);return e.reverse(),e},each:function(a,b){if(t!=a.length)for(var d=0,e=a.length;e>d&&!1!==b.call(a[d],d,a[d]);d++);else for(name in a)b.call(a[name],name,a[name])},index:function(a,b){var d,e=b.length;for(d=0;e>d;d++)if(a==b[d])return d;return-1},trim:function(a){return a.replace(/^(\s|\u00A0)+/,"").replace(/(\s|\u00A0)+$/,"")},getjson:function(){var c=a.fn.getByClassName("hermit"),b=c.length-1;a.fn.each(c,function(c){var e=this,g=e.getAttribute("songs").split("#:");a.fn.ajaxp({url:"http://goxiami.duapp.com/",param:{type:g[0],id:g[1]},after:function(g){a.fn.createPlayListUI.call(e,g,c);b==c&&a.fn.autoPlay()}})});a.fn._log("Hermit 1.0.4 is ready to biu biu biu now.")},create:function(c){var b=this;j=null!=c?c:0;i=null!=i?i:0;a.sound&&(a.sound.destruct(),i==k[j].songs.length&&(i=0));l.onready(function(){a.sound=l.createSound({id:"goXiami",url:k[j].songs[i].src,volume:80,autoLoad:!1,onload:function(){3>this.readyState&&(a.fn.getByClassName("hermit-detail",b,"div")[0].innerHTML="\u97f3\u4e50\u64ad\u653e\u5668\u521d\u59cb\u5316\u5931\u8d25!")},whileloading:function(){a.fn.getByClassName("hermit-loaded",b,"div")[0].style.width=100*(this.bytesLoaded/this.bytesTotal)+"%"},whileplaying:function(){var c=a.fn.getByClassName("hermit-duration",b,"div")[0],e=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],g=100*(this.position/this.duration)+"%",h=a.fn.parseTime(this.position/1E3)+"/"+a.fn.parseTime(this.duration/1E3);!a.moving&&(e.style.width=g);c.innerHTML=h},onplay:function(){var c=a.fn.getByClassName("hermit-song",b,"div"),e=a.fn.getByClassName("hermit-detail",b,"div")[0],g=c[i].innerHTML;a.fn.each(c,function(){a.fn.removeClass(this,"selected")});a.fn.addClass(c[i],"selected");e.innerHTML=a.fn._expect(g,0,40,"...")+"  ("+(i+1)+"/"+k[j].songs.length+")";a.fn._log('Hermit 1.0.4 is playing "%s" now.',g)},onpause:function(){},onfinish:function(){if(i++,a.sound.resume(),i<k[j].songs.length?1:k[j].loop?(i=0,1):0)a.fn.create.call(b,j);else{var c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],e=a.fn.getByClassName("hermit-button",b,"div")[0],g=a.fn.getByClassName("hermit-duration",b,"div")[0],h=a.fn.getByClassName("hermit-song",b,"div");a.fn.each(h,function(){a.fn.removeClass(this,"selected")});c.style.width=0;j=i=null;a.sound=null;g.innerHTML="";a.fn.removeClass(e,"playing")}}});a.sound.play()})},createPlayListUI:function(c,b){var d=parseInt(this.getAttribute("auto"),10),e=parseInt(this.getAttribute("loop"),10),g=a.fn.getByClassName("hermit-list",this,"div")[0],h="";k[b]={element:this,auto:d,loop:e,songs:[]};c.album_id||c.collect_id?(c=c.songs,a.fn.each(c,function(){null!=this&&(k[b].songs.push({src:this.song_src}),h+='<div class="hermit-song">'+this.song_title+" - "+this.song_author+"</div>")})):(d=this.getAttribute("songs").split("#:")[1],d=d.split(","),a.fn.each(d,function(){null!=c[this]&&(k[b].songs.push({src:c[this].song_src}),h+='<div class="hermit-song">'+c[this].song_title+" - "+c[this].song_author+"</div>")}));g.innerHTML=h;a.fn.playEvent.call(this)},playEvent:function(){var c=this,b=a.fn.getByClassName("hermit-button",c,"div")[0],d=a.fn.getByClassName("hermit-listbutton",c,"div")[0],e=a.fn.getByClassName("hermit-list",c,"div")[0],g=a.fn.getByClassName("hermit-song",e,"div"),h=(parseInt(a.fn._getStyle(g[0],"height"))+1)*g.length,f=a.fn.getByClassName("hermit-prosess",c,"div")[0],k=a.fn.getByClassName("hermit-prosess-after",f,"div")[0],h=360>=h?h:360,h=h+"px";e.style.height=h;a.fn.each(g,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));a.fn.bind(o,this,function(){var e=a.fn.index(this,g);if(j==d)e==i?b.click():(i=e,a.fn.create.call(c,d));else{if(a.sound){var f=a.fn.getByClassName("hermit")[j],h=a.fn.getByClassName("hermit-button",f,"div")[0],f=a.fn.getByClassName("hermit-song",f,"div")[i];a.fn.removeClass(h,"playing");a.fn.removeClass(f,"selected");a.sound.resume()}i=e;a.fn.addClass(b,"playing");a.fn.create.call(c,d)}})});a.fn.bind(o,b,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));if(a.fn.hasClass(b,"playing"))a.fn.removeClass(b,"playing"),a.sound.pause();else if(a.fn.addClass(b,"playing"),a.sound&&j==d)a.sound.play();else{if(a.sound){var e=a.fn.getByClassName("hermit")[j],f=a.fn.getByClassName("hermit-button",e,"div")[0],e=a.fn.getByClassName("hermit-song",e,"div")[i];i=null;a.fn.removeClass(f,"playing");a.fn.removeClass(e,"selected")}a.fn.create.call(c,d)}});a.fn.bind(o,d,function(){a.fn.hasClass(c,"unexpand")?(a.fn.removeClass(c,"unexpand"),e.style.height=h):(a.fn.addClass(c,"unexpand"),e.style.height=0)});a.fn.bind(o,f,function(c){if(a.sound){var b=parseInt(a.fn._getStyle(f,"width")),d=a.fn._offset(f).left,c=a.fn._pageEvent(c).pageX-d,c=c/b*a.sound.duration;a.sound.setPosition(c)}});a.fn.bind(w,k,a.fn._bind(a.fn._start,c))},autoPlay:function(){a.fn.each(k,function(c,b){if(b&&b.auto)return a.fn.getByClassName("hermit-button",b.element,"div")[0].click(),a.fn._log("Songs list %d now playing auto.",c+1),!1})},_pageEvent:function(a){if(a=a||p.event,m&&a.touches.length)a.pageX=a.touches.item(0).pageX,a.pageY=a.touches.item(0).pageY;else if("undefined"==typeof a.pageX){var b=f.documentElement,d=f.body;a.pageX=a.clientX+(b&&b.scrollLeft||d&&d.scrollLeft||0)-(b&&b.clientLeft||d&&d.clientLeft||0);a.pageY=a.clientY+(b&&b.scrollTop||d&&d.scrollTop||0)-(b&&b.clientTop||d&&d.clientTop||0)}return a},_expect:function(a,b,d,e){return e=a.length>d-b?e:"",a=a.slice(b,d),a+e},_offset:function(a){var b=a.getBoundingClientRect(),d=a.ownerDocument,a=d.body,d=d.documentElement;return{top:b.top+(self.pageYOffset||d.scrollTop||a.scrollTop)-(d.clientTop||a.clientTop||0),left:b.left+(self.pageXOffset||d.scrollLeft||a.scrollLeft)-(d.clientLeft||a.clientLeft||0)}},_getStyle:function(a,b){return 5<n&&9>n?(b=b.replace(/^(\w)/g,function(a,c){return c.toUpperCase()}),a["client"+b]):f.defaultView.getComputedStyle(a,null).getPropertyValue(b)},_bind:function(a,b){return function(){return a.apply(b,arguments)}},_start:function(){a.moving=!0;a.fn.bind(u,f,a.fn._bind(a.fn._move,this));a.fn.bind(v,f,a.fn._bind(a.fn._end,this));a.fn.bind("touchcancel",f,a.fn._bind(a.fn._end,this))},_move:function(c){event=a.fn._pageEvent(c);var b=a.fn.getByClassName("hermit-prosess",this,"div")[0],c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],d=parseInt(a.fn._getStyle(b,"width")),b=a.fn._offset(b).left,b=event.pageX-b,d=b/d;c.style.width=100*(1<d?1:d)+"%"},_end:function(){a.fn.getByClassName("hermit-prosess-after",this,"div")[0];if(a.sound){var c=a.fn.getByClassName("hermit-prosess",this,"div")[0],b=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],c=parseInt(a.fn._getStyle(c,"width")),b=parseInt(a.fn._getStyle(b,"width")),b=b/c,b=(1<b?1:b)*a.sound.duration;a.sound.setPosition(b)}a.fn.unbind(u,f);a.fn.unbind(v,f);a.fn.unbind("touchcancel",f);try{delete a.moving}catch(d){a.moving=t}a.fn.handleHash={}},ajaxp:function(c){setTimeout(function(){var b=(new Date).valueOf(),d=f.createElement("script");body=f.documentElement;head=body.getElementsByTagName("head")[0];callbackName="hermit"+parseInt(999999*Math.random());c.param.callback=callbackName;c.param._=b;p[callbackName]=function(a){c.after.call(this,a);head.removeChild(d)};d.src=c.url+"?"+a.fn.serialize(c.param);head.appendChild(d)},0)},_loadScript:function(c,b){setTimeout(function(){var d=f.createElement("script");d.src=c;d.readyState?a.fn.bind("readystatechange",d,function(){("loaded"===d.readyState||"complete"===d.readyState)&&(b&&b(),a.fn.unbind("readystatechange",d))}):a.fn.bind("load",d,function(){b&&b();a.fn.unbind("load",d)});f.getElementsByTagName("head")[0].appendChild(d)},0)},_log:window.console?function(){console.log.apply(console,arguments)}:!1,serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}};a.init()})(window,document);