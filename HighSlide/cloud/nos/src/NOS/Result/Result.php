...
abstract class Result
{
    ...
    {
        if ($response === null) {
            throw new NosException("raw response is null");
        }
    ...
    public function getRequestId()
    {
        if (isset($this->rawResponse) &&
            ...
            isset($this->rawResponse->header['x-nos-request-id'])
        ) {
            return $this->rawResponse->header['x-nos-request-id'];
        } else {
            return '';
        }
    }
    ...
    public function parseResponse()
    {
        ...
        if ($this->isOk) {
            ...
            throw new NosException($details);
        }
    }
