...
本文件为**新版插件仓库**:toolbox:[**TeStore**](TeStore)获取插件列表数据专用，内容为Markdown格式文本，解析部分为下方表格的Html源码，在“设置”-“插件信息来源”中填写地址 https://github.com/typecho-fans/plugins/blob/master/TESTORE.md 即可生效。
...
[APlayerAtBottom](https://github.com/satosouta/APlayerAtBottom) | 给博客底部添加悬浮播放器（支持网易云音乐/QQ音乐歌单） | 1.1.1 | [小太](https://github.com/satosouta) | [下载](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/APlayerAtBottom.zip)
