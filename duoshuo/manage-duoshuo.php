			...
			switch ($act) {
				...
				case 'setting':
					echo '<div id="duoshuo-remote-window" class="conbox">
							...
							<p id="ds-export">
							<button value="Export" class="primary" id="btn-export" onclick="fireExport(1);">点我同步一下</button>
							</p>
							<div class="tip">
